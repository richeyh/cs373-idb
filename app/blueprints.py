...
blueprint.add_url_rule('/api/books/', defaults={'book_id':None}, view_func=BookAPI.as_view('BooksAPI'))
blueprint.add_url_rule('/api/books/<book_id>', view_func=BookAPI.as_view('BookAPI'))
blueprint.add_url_rule('/api/authors/', defaults={'author_id':None}, view_func=AuthorAPI.as_view('AuthorsAPI'))
blueprint.add_url_rule('/api/authors/<author_id>', view_func=AuthorAPI.as_view('AuthorAPI'))
